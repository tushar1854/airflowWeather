...
def transform_load_data(task_instance):
    ...
    dt_string = 'current_weather_data_new-delhi_' + dt_string
...
default_args = {
    ...
    "email": ["tusharsaini1854@gmail.com"],
...
with DAG('weather_dag', default_args=default_args, schedule_interval='@daily', catchup=False) as dag:
    is_weather_api_ready = HttpSensor(
        ...
        endpoint='/data/2.5/weather?q=new%20delhi&appid=67e03d977a15ec4601896fa84ca34103',
    )
